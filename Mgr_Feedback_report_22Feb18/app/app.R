...
#setwd("~/Mercer.Work/analytics/IMDA_SF/Shiny_app_skills_feedback/Skills_survey_report_app/Shiny_app_feedback_report/Mgr_Feedback_report_22Feb18/Mock_up_data_for_app.xlsx")

dirname <- "~/Mercer.Work/analytics/IMDA_SF/Shiny_app_skills_feedback/Skills_survey_report_app/Shiny_app_feedback_report/Mgr_Feedback_report_22Feb18/app"
...
ui <- fluidPage(
   theme = shinytheme("cerulean"), #or "sanstone"
