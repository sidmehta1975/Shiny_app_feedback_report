...
dirname <- "~/Mercer.Work/analytics/IMDA_SF/Shiny_app_skills_feedback/Skills_survey_report_app/Shiny_app_feedback_report/Mgr_Feedback_report_22Feb18/journal"
...
ui <- fluidPage(
   theme = shinytheme("journal"), #or "sanstone"
